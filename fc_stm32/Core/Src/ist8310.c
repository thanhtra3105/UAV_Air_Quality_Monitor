...
float ist8310_offset_x = -0.00208472833; // -0.00342648476f;		//
float ist8310_offset_y = -0.00152314082; // -0.00129438564f;
float ist8310_offset_z = -0.00305779465; // -0.00363003276f;

//float ist8310_offset_x = -0.00342648476f;
//float ist8310_offset_y = -0.00129438564f;
//float ist8310_offset_z = -0.00363003276f;
...
uint8_t IST8310_Read(I2C_HandleTypeDef *hi2c, IST8310_Data_t *magData) {
	...
	magData->mag_x -= ist8310_offset_x;
	magData->mag_y -= ist8310_offset_y;
	magData->mag_z -= ist8310_offset_z;
...
void IST8310_Calibrate(I2C_HandleTypeDef *hi2c, uint32_t duration_ms) {
	...
	ist8310_offset_x = 0.0f;
	ist8310_offset_y = 0.0f;
	ist8310_offset_z = 0.0f;
	...
	ist8310_offset_x = (max_x + min_x) / 2.0f;
	ist8310_offset_y = (max_y + min_y) / 2.0f;
	ist8310_offset_z = (max_z + min_z) / 2.0f;
}
